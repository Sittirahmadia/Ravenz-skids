...
public class CategoryPanel {
    ...
    public void render(int mouseX, int mouseY, float alpha, float scale, int centerX, int centerY) {
        ...
        boolean scrollable = com.raven.ravenz.module.modules.client.ClientSettingsModule.isScrollable();
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        if (!com.raven.ravenz.module.modules.client.ClientSettingsModule.isScrollable()) {
            return false;
        }
    ...
    public String getTooltipText() {
        if (hoveredModule != null && com.raven.ravenz.module.modules.client.ClientSettingsModule.isModuleDescriptionsEnabled()) {
    ...
    public void renderBlur(MatrixStack matrices, float alpha, float scale, int centerX, int centerY) {
        ...
        float blurRadius = com.raven.ravenz.module.modules.client.ClientSettingsModule.getPanelBlurRadius();
