package com.raven.ravenz.gui.newgui;

import com.raven.ravenz.module.Category;
import com.raven.ravenz.module.Module;
import com.raven.ravenz.gui.newgui.components.CategoryPanel;
import com.raven.ravenz.gui.newgui.components.ConfigPanel;
...
public class NewClickGUI extends Screen {
    ...
    private void initPanels() {
        ...
        for (Category category : Category.values()) {
            ...
            List<Module> modules = com.raven.ravenz.RavenZClient.INSTANCE.getModuleManager().getModulesByCategory(category);
            if (!modules.isEmpty()) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (com.raven.ravenz.module.modules.client.ClientSettingsModule.isPanelBlurEnabled()) {
            for (CategoryPanel panel : panels) {
                if (panel != draggedPanel) {
                    panel.renderBlur(new MatrixStack(), alpha, scale, centerX, centerY);
                }
            }
            if (configPanel != null && !configDragging) {
                configPanel.renderBlur(new MatrixStack(), alpha, scale, centerX, centerY);
            }
            if (draggedPanel != null) {
                draggedPanel.renderBlur(new MatrixStack(), alpha, scale, centerX, centerY);
            }
            if (configPanel != null && configDragging) {
                configPanel.renderBlur(new MatrixStack(), alpha, scale, centerX, centerY);
            }
        ...
        if (com.raven.ravenz.module.modules.client.ClientSettingsModule.isSnowEffectEnabled()) {
    ...
    private void renderFriendsButton(float alpha) {
        ...
        Color accentColor = com.raven.ravenz.module.modules.client.NewClickGUIModule.getAccentColor();
    ...
    public boolean charTyped(CharInput input) {
        ...
        if (com.raven.ravenz.module.modules.client.ClientSettingsModule.isAutoFocusSearchEnabled()) {
    ...
    private void renderPanelGlows(DrawContext context, float alpha, float scale, int centerX, int centerY,
        ...
        if (!com.raven.ravenz.module.modules.client.ClientSettingsModule.isGuiGlowEnabled()) {
            return;
        }
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        if (com.raven.ravenz.module.modules.client.ClientSettingsModule.isGuiBlurEnabled()) {
