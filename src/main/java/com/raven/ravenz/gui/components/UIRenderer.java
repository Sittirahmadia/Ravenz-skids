...
public class UIRenderer {
    ...
    public static void renderCheckbox(DrawContext context, int x, int y, int size, boolean enabled, Color borderColor, Color fillColor) {
        ...
        renderBorder(context, x, y, size, size, borderColor.getRGB());
    }

    public static void renderBorder(DrawContext context, int x, int y, int width, int height, int color) {
    ...
    public static Color getCategoryColor(Category category) {
        return switch (category) {
            ...
            case CREDITS -> new Color(255, 215, 100);
        };
    }
}
