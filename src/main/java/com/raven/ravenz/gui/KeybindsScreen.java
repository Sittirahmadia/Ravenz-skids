...
public class KeybindsScreen extends Screen {
    ...
    private void renderBackground() {
        NanoVGRenderer.drawRect(0, 0, width, height, com.raven.ravenz.module.modules.client.KeybindsModule.getBackgroundColor());
    }
    ...
    private void renderModuleSearchPopup(int mouseX, int mouseY) {
        ...
        NanoVGRenderer.drawRoundedRectOutline(popupX, popupY, POPUP_WIDTH, POPUP_HEIGHT, 8f, 2f, com.raven.ravenz.module.modules.client.KeybindsModule.getAccentColor());
    ...
    private void renderModuleEntry(Module module, float popupX, float moduleY, int mouseX, int mouseY) {
        ...
        if (isHovered) {
            NanoVGRenderer.drawRoundedRect(popupX + 20, moduleY, POPUP_WIDTH - 40, 30, 4f, com.raven.ravenz.module.modules.client.KeybindsModule.getKeyHoverColor());
        }
    ...
    private void renderKey(KeyButton button, boolean isHovered) {
        ...
        if (boundModule != null) {
            NanoVGRenderer.drawRoundedRectOutline(button.x, button.y, button.width, button.height, 4f, 2f,
                com.raven.ravenz.module.modules.client.KeybindsModule.getKeyAssignedColor());
        }
    ...
    private Color getKeyColor(Module boundModule, boolean isHovered, boolean isWaitingForKey) {
        if (isWaitingForKey && isHovered) return com.raven.ravenz.module.modules.client.KeybindsModule.getKeySelectedColor();
        if (boundModule != null) {
            if (isHovered) {
                Color assigned = com.raven.ravenz.module.modules.client.KeybindsModule.getKeyAssignedColor();
                return new Color(
            ...
            return com.raven.ravenz.module.modules.client.KeybindsModule.getKeyAssignedColor();
        }
        if (isHovered) return com.raven.ravenz.module.modules.client.KeybindsModule.getKeyHoverColor();
        return com.raven.ravenz.module.modules.client.KeybindsModule.getKeyColor();
    }
    ...
    private void renderInstructions() {
        ...
        Color instrColor = selectedModule != null ? com.raven.ravenz.module.modules.client.KeybindsModule.getKeySelectedColor() : new Color(150, 150, 160, 255);
    ...
    private void assignKeyToModule(Module module, int keyCode) {
        for (Module other : RavenZClient.INSTANCE.getModuleManager().getModules()) {
