...
import com.raven.ravenz.module.modules.movement.SnapTap;
...
public final class ModuleManager {
    ...
    private void addModules() {
        ...
        add(
                ...
                new AutoAnchor(), new KeyAnchor(), new AnchorMacroV2(), new AutoHitCrystal(),
                new AutoCrystal(), new AutoDtap(),
                new com.raven.ravenz.module.modules.combat.AIT(), new com.raven.ravenz.module.modules.combat.AutoInventoryTotem(), new TriggerBotV2(),
                new TriggerBotV3());
        // Movement
        add(new Sprint(), new AutoFirework(), new AutoHeadHitter(), new KeepSprint(), new SnapTap(), new AutoDoubleHand());
