...
public final class AutoDrain extends Module {
    ...
    private final NumberSetting actionCooldownMs = new NumberSetting("Cooldown MS", 50, 2000, 250, 1);
    private final NumberSetting switchBackDelayMs = new NumberSetting("SwitchBack MS", 0, 500, 75, 1);
