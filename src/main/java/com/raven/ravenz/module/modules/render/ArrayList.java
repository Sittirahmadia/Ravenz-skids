...
public class ArrayList extends Module {
    ...
    private List<Module> getSortedEnabledModules() {
        List<Module> enabledModules = RavenZClient.INSTANCE.getModuleManager().getEnabledModules();
    ...
    private class RenderContext {
        ...
        RenderContext() {
            ...
            this.accentColor = com.raven.ravenz.module.modules.client.NewClickGUIModule.getAccentColor();
