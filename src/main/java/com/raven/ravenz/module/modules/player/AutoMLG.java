...
public final class AutoMLG extends Module {
    ...
    private void handlePickup() {
        ticks++;
        // Wait until player is on ground or in water (landed), then wait 3 ticks for water to place
        boolean landed = mc.player.isOnGround() || mc.player.isTouchingWater();
        if (!landed || ticks < 3) return;
